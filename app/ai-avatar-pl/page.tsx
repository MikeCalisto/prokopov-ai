...
import Popup from "@/components/ai-avatar-pl/Popup";
    ...
    <div className="page-wrapper">
      ...
      <section className="px-4 py-10 text-center">
        ...
        <div className="flex justify-center gap-3 mt-3 opacity-50">
          ...
          <span className="text-xs text-gray-400">PayU</span>
        </div>
      </section>
      ...
      <footer className="px-4 pt-8 pb-6 border-t border-gray-800">
        ...
        <div className="flex flex-col items-center gap-2.5 mb-6">
          <a href="/ai-avatar-pl/polityka-prywatnosci" className="text-gray-400 text-xs underline underline-offset-2 hover:text-white transition-colors">
            POLITYKA PRYWATNOŚCI
          </a>
          <a href="/ai-avatar-pl/regulamin" className="text-gray-400 text-xs underline underline-offset-2 hover:text-white transition-colors text-center">
            REGULAMIN ŚWIADCZENIA USŁUG / OFERTA PUBLICZNA
          </a>
          <a href="/ai-avatar-pl/polityka-zwrotow" className="text-gray-400 text-xs underline underline-offset-2 hover:text-white transition-colors">
            POLITYKA ZWROTÓW
          </a>
        </div>
