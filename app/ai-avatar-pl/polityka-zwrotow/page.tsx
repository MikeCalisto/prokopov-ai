...
export default function PolitikaZwrotowPage() {
  return (
    <LegalPage title="Polityka Zwrotów">
      ...
      <Section title="2a. Adres do zwrotów i korespondencji">
        <p>
          Oświadczenia o odstąpieniu od umowy, reklamacje oraz wszelką
          korespondencję w sprawach zwrotów należy kierować na poniższe dane:
        </p>
        <ul>
          <li>
            <strong>E-mail (preferowana forma):</strong> Roman.prockopov@gmail.com
          </li>
          <li>
            <strong>Adres korespondencyjny:</strong> ROMAN PROKOPOV,
            ul. Adama Jerzego Czartoryskiego 61/37, 51-126 Wrocław, Polska
          </li>
        </ul>
        <p>
          Z uwagi na cyfrowy charakter usługi (kurs online) zwrot fizyczny
          towaru nie jest wymagany — wystarczy przesłanie oświadczenia o
          odstąpieniu od umowy drogą elektroniczną na podany adres e-mail.
        </p>
      </Section>
