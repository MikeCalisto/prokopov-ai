...
export default function Popup({ isOpen, onClose }: PopupProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      window.location.href = "/ai-avatar-pl/payment-error";
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start gap-3">
            ...
            <label htmlFor="terms" className="text-gray-300 text-sm cursor-pointer">
              Akceptuję{" "}
              <a href="/ai-avatar-pl/regulamin" target="_blank" className="underline text-white hover:text-accent">
                Regulamin
              </a>{" "}
              oraz{" "}
              <a href="/ai-avatar-pl/polityka-prywatnosci" target="_blank" className="underline text-white hover:text-accent">
